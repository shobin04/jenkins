    ...
    stage('SonarQube') {
          ...
          steps {
            withSonarQubeEnv('SonarQube') {
                sh '''cd /var/lib/jenkins/workspace/java-maven-project/java-maven-master
        ...
        stage ('deploy') {
            steps {
                 sh"""sudo cp /var/lib/jenkins/workspace/java-maven-project/java-maven-master/target/my-app-1.0-SNAPSHOT.war /opt/tomcat/webapps
